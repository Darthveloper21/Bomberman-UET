...
player2::player2(SDL_Renderer* renderer, SDL_Texture* texture, int x, int y, int framex, int framey)
{
...
void player2::draw2(SDL_Renderer* renderer, SDL_Texture* texture)
{
